...
int main()
{
	...
	unsigned int diffuseMap = loadTexture("container2_specular.png");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		{
			glm::mat4 modelA;
			modelA = glm::translate(model, cubePositions[i]);
			float angle = 20.0f * i*glfwGetTime();
			modelA = glm::rotate(modelA, glm::radians(angle), glm::vec3(1.0f, 0.3f, 0.5f));
